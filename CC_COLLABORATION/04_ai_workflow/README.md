...
> 最后更新：2026-01-02
> 状态：框架定稿
> 文档类型：**框架参考手册**（Framework Reference）

---

## 概述

本文档定义了 AI 协作开发的 **8 阶段工作流框架**，是框架的「规范定义」文档。
...
> 📘 **实战操作指南**：日常开发流程、命令用法、实战示例请参见 [DAILY_WORKFLOW_GUIDE.md](./DAILY_WORKFLOW_GUIDE.md)
...
> 📘 **命令速查表**：完整的命令用法和示例请参见 [DAILY_WORKFLOW_GUIDE.md - 命令速查表](./DAILY_WORKFLOW_GUIDE.md#4-命令速查表)

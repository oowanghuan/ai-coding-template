...
根据 `00_CONTEXT.md` 中定义的功能需求，自动生成完整的规格文档：
- `11_UI_FLOW_SPEC.md` - UI 流程规格（前端功能）
- `11_API_SPEC.md` - API 规格（后端功能）
...
- `docs/{feature}/11_API_SPEC.md` - API 规格（如适用）
...
1. **CONTEXT 依赖**：必须先有完整的 00_CONTEXT.md

...
根据用户提供的需求描述，智能生成 `00_CONTEXT.md` 功能上下文文档，包括功能概述、用户故事、边界条件等内容。
...
- `docs/{feature}/00_CONTEXT.md` - 完整的功能上下文文档
...
- 设计文档：`10_DESIGN_FINAL.md`（待创建）
- UI 规格：`11_UI_FLOW_SPEC.md`（待创建）
- 进度日志：`30_PROGRESS_LOG.yaml`（待创建）
```
